                        ...
                        <div class="mb-4 md:mb-0">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 mt-1">Manage team members for: <span class="font-medium">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <c:if
                                                test="${member.user.id != project.owner.id and sessionScope.user.id == project.owner.id}">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900">
                                            ${memberTaskCounts[member.user.id] != null ?
                                            memberTaskCounts[member.user.id] : 0} tasks
                                        </p>
                                    </div>
